...
unsigned short calculateCRC16(const std::vector<unsigned char>& data) {
    ...
    for (unsigned char byte : data) {
        unsigned int uIndex = uchCRCHi ^ byte;
...
void CalculatCRC::AppendCRC16(QByteArray &datas)
{
...
QByteArray CalculatCRC::UInt2ByteArray(uint num)
{
...
void CalculatCRC::UInt2ByteArrayR(uint num, QByteArray &byteArray,
...
QByteArray CalculatCRC::String2ByteArray(const QString &strInput)
{
    // 默认分隔符为空格，默认进制为十六进制
    const QString sep = " ";
    int base = 16;
    ...
    {
        byteArray[i] = strBytes[i].toInt(nullptr, base);
    }
